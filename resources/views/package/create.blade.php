		        ...
		        <div class="col-md-6">
		            ...
		            <form action="{{ route('package.store') }}" method="post">
		                ...
		                <div class="form-group {{ $errors->has('rate') ? 'has-error' : '' }}">
		                    ...
		                    <input class="form-control" type="number" name="rate" id="rate" value="{{ Request::old('rate') }}"></input>
		                </div>
		                ...
		                <div class="form-group {{ $errors->has('grace_period') ? 'has-error' : '' }}">
		                    ...
		                    <input class="form-control" type="number" name="grace_period" id="grace-period" value="{{ Request::old('grace_period') }}"></input>
		                </div>
