...
<head>
    ...
    <!-- Slim CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/slim.css')); ?>" rel="stylesheet">
...
<body data-gr-c-s-loaded="true">
    <div class="slim-header">
      <div class="container">
        <div class="slim-header-left">
          <h2 class="slim-logo"><a href="<?php echo e(url('/')); ?>">slim<span>.</span></a></h2>
    ...
    <div class="slim-navbar">
      <div class="container">
        <ul class="nav">
          ...
          <li class="nav-item with-sub">
            <a class="nav-link" href="http://themepixels.me/slim/template/index.html#" data-toggle="dropdown">
              <i class="icon ion-ios-gear-outline"></i>
              <span>Forms</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="http://themepixels.me/slim/template/page-messages.html">
    ...
    <script src="<?php echo e(asset('js/chartlist.js')); ?>"></script>
    <script src="<?php echo e(asset('js/d3.js')); ?>"></script>
    <script src="<?php echo e(asset('js/rickshaw.min.js')); ?>"></script>
