    ...
    <?php $__env->startSection('title'); ?> Create Package! <?php $__env->stopSection(); ?>
		        ...
		        <div class="col-md-6">
		            ...
		            <form action="<?php echo e(route('package.store')); ?>" method="post">
		                ...
		                <div class="form-group <?php echo e($errors->has('rate') ? 'has-error' : ''); ?>">
		                    ...
		                    <input class="form-control" type="number" name="rate" id="rate" value="<?php echo e(Request::old('rate')); ?>"></input>
		                </div>
		                ...
		                <div class="form-group <?php echo e($errors->has('grace_period') ? 'has-error' : ''); ?>">
		                    ...
		                    <input class="form-control" type="number" name="grace_period" id="grace-period" value="<?php echo e(Request::old('grace_period')); ?>"></input>
		                </div>
